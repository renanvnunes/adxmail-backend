...
cron.schedule('*/240 * * * * *', async () => {
	...
	// 	try {
	// 		await axios
	// 			.get(`${url}/xml/process_queue`)
	// 			.then((resp) => {})
	// 			.catch(async (error) => {
	// 				await redis_client.set(
	// 					'logs_crons:erro:process_queue',
	// 					'Erro ao rodar a cron de (process_queue) - ' + error,
	// 					60
	// 				);
	// 			});
	// 	} catch (e) {}
	// } else {
	// 	await redis_client.set(
	// 		'logs_crons:aviso:process_xml',
	// 		'Fora do horário de atualização de produtos. Minuto atual: ' + moment().format('mm'),
	// 		60
	// 	);
	// }
	// }
